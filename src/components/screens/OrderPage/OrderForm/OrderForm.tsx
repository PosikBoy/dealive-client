      ...
      {isPriceInfo && (
        ...
        >
          <div className={styles.modalWindow__content}>
            <p>
              Пока что наш сервис не умеет считать цену, поэтому у вас есть
              возможность предложить цену самостоятельно.
            </p>
            <p>
              Обратите внимание, что курьеры не поедут за сильно маленькую цену
              и с радостью выполнят ваш заказ, если он будет хорошо оплачен.
            </p>
            <p>Примерные цены:</p>
