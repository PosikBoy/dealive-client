      ...
      <div className="container">
        <div className="wwd__grid">
          ...
          <div className="wwd__item wwd__item_text wwd__item_3">
            ...
            <p>
              Мы предоставляем услуги по перевозке грузов различного размера: от
              небольших посылок, таких как цветы, документы и подарки, до
              крупногабаритных коробок и пакетов.
            </p>
          </div>
