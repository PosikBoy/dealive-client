        ...
        >
          <div className={styles.modalWindow__content}>
            <p>
              ...
              уникальную возможность самостоятельно установить справедливую
              цену, которая устроит вас и наших опытных курьеров.
            </p>

            <p>
              Помните, что профессиональные курьеры заслуживают достойной оплаты
              за качественную и оперативную работу. Предложив курьерам
              достаточно привлекательную ставку, вы гарантированно получите
              быструю и надежную доставку вашего заказа.
            </p>
            ...
            <p>
              Определите справедливую цену и обеспечьте себе максимально
